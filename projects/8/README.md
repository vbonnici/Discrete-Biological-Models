...
2) segmentazione a dizionario: si considera una lunghezza di parola $k$ tra 3 e 6, quindi si estraggono dei segmenti disgiunti ma contigui (senza vuoti intermedi) tale che ogni segmento contiene tutte le ppossibili parole di lunghezza $k$ (ovvero $\Gamma^k$)
